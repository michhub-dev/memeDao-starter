...
(async () =>{
    try {
     const voteGovContract = await sdk.deployer.deployVote({
         ...
         voting_token_location: "0x218D3686d4d45E5ecAaAb8b451a1cF13A93329Ec",
     ...
     console.log("Successfully deployed a contract, address", voteGovContract);
    } catch (error) {
        console.log("Failed to deploy the vote com", error);
    }
})();